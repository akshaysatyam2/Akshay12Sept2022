...
<div class="mainBody">
	...
	<h1><u>Choosen Course Details:-</u></h1>
	<table border="3px solid black">
	<tr>
		...
		<%
				...
				try {
					...
					Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/Akshay12Sept2022", "admin", "admin");
					Statement st = cn.createStatement();
					ResultSet rs = st.executeQuery("SELECT * FROM sAcademicCourse INNER JOIN sCourseTaken ON sAcademicCourse.courseName = sCourseTaken.courseName where user like \"" + suser + "\"");
					while (rs.next() == true) {
			%>
				<tr>
