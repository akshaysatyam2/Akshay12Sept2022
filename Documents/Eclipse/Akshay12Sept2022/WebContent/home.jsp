...
<body>
	...
	<div class="topnav" id="myTopnav">
		<a class="active">Student Information System</a> <a href="home.html">Home</a>
		<a href="studentLogin.html">Student Login</a> <a
			href="employeeLogin.html">Employee Login</a> <a href="contactUS.html">Contact
			Us</a> <a href="javascript:void(0);" class="icon"
					...
					<table border="3px solid black">
						<%
							try {
								...
								ResultSet rs = st.executeQuery("select * from Notices WHERE count='1' ");
								while (rs.next() == true) {
						%>
		...
		<%
			try {
				...
				Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/Akshay12Sept2022", "admin",
						"admin");
				Statement st = cn.createStatement();
				ResultSet rs = st.executeQuery("select * from Notices ORDER BY (count) limit 1");
				while (rs.next() == true) {
		%>
	...
	<%
			try {
				...
				Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/Akshay12Sept2022", "admin",
						"admin");
				Statement st = cn.createStatement();
				ResultSet rs = st.executeQuery("select * from Notices where not count='1' order by (count)desc;");
				while (rs.next() == true) {
		%>
